...
import numpy as np
# import pickle    ##causes bug: => >> pip install pickle5  + the bellow replacement:
import pickle5 as pickle
import logging
import h5py
from sklearn.model_selection import train_test_split
### modified utils.py, got from InfoGCN project: 
from utils_infogcn import create_aligned_dataset
...
if __name__ == '__main__':
    ...
    create_aligned_dataset(file_list=['NTU120_CSet.npz', 'NTU120_CSub.npz'])       # ..Csub.npz -> correction : ...CSub.npz
